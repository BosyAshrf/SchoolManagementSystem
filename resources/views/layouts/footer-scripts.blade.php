...
<!-- // الكود ده عشان الشيك بوكس اما تضغط ع اول واحده يحدد الكل واما تشيلها يشيل الباقي -->
<script>
...
<!-- // Ajax الكود ده عشان اما يختار المراحل الدراسية يعبي الصفوف الدراسيه والاقسام-->
<script>
...
<!-- // Ajax الكود ده عشان نرقية الطلاب اما يختار المراحل الدراسيةالجديدة يعبي الصفوف الدراسيه الجديدة والاقسام-->
<script>
    $(document).ready(function () {
