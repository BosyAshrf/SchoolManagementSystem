                    ...
                    <form method="post" action="{{ route('Fees.store') }}" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('Fees.name_fees_ar') }} :</label>
                                <input type="text" value="{{ old('title_ar') }}" name="title_ar" class="form-control">
                            </div>

                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('Fees.name_fees_en') }} :</label>
                                <input type="text" value="{{ old('title_en') }}" name="title_en" class="form-control">
                            </div>


                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('Fees.amount_fees') }} :</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{trans('Students.classrooms')}} : </label>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Fee_type">
                                     <option selected disabled>{{trans('Parents.Choose')}}...</option>
                                    <option value="1">{{ trans('Fees.school_fee') }}</option>
