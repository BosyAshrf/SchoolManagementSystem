...
@section('css')
    @toastr_css
@section('title')
{{ trans('FeesInvoices.Add_New') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('FeesInvoices.Add_New') }} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <form class=" row mb-30" action="{{ route('Fees_Invoices.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Fees.amount_fees') }}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="notes" class="mr-sm-2">{{ trans('Fees.notes') }}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Grades.Actions') }}:</label>
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ trans('Classrooms.Save') }}</button>
                                </div>
                            </div>
                        </form>
