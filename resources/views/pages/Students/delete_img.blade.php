...
<div class="modal fade" id="Deleteimage{{$attachment->id}}" tabindex="-1" 
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Students.Delete_attachment')}}</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{route('Delete_attachment','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students.Delete_attachment_tilte')}}</h5>
