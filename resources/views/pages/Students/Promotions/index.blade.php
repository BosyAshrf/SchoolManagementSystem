...
@section('css')
    @toastr_css
@section('title')
    {{trans('Promotions.Students_Promotions')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <h6 style="font-family: 'Cairo', sans-serif;color: blue"> {{trans('Promotions.Old_Grades')}} <span class="text-danger">**</span></h6><br>
                ...
                <form method="post" action="{{ route('Promotions.store') }}">
                    ...
                    <br><h6 style="font-family: 'Cairo', sans-serif;color: blue">{{trans('Promotions.New_Grades')}} <span class="text-danger">**</span></h6><br>
